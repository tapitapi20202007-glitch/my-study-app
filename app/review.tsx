...
const styles = StyleSheet.create({
  ...
  progressBarBg: {
    height: 6, backgroundColor: '#e0e0e0', borderRadius: 99, marginBottom: 20,
  },
  progressBarFill: { height: 6, backgroundColor: '#2196F3', borderRadius: 99 },
  mainQuestionBox: {
    backgroundColor: '#E3F2FD', borderRadius: 10, padding: 16, marginBottom: 16,
  },
  ...
  answerBox: {
    backgroundColor: '#FFF9C4', borderRadius: 8, padding: 12, marginBottom: 12,
  },
  ...
  button: {
    padding: 14, borderRadius: 10, alignItems: 'center', marginTop: 8, marginBottom: 4,
  },
